...
A Flask application to generate cash receipts
...
Run the following commands to bootstrap your environment ::
    ...
    git clone https://github.com/nycrecords/flask_cash_receipts
    cd flask_cash_receipts
    pipenv install --dev
    cp .env.example .env
    npm install
...
* Create Heroku App. You can leave your app name, change it, or leave it blank (random name will be generated)::
    ...
    heroku create flask_cash_receipts
